...
public class ExpressionParser<T> implements Parser {
    ...
    public TripleExpression<T> parse(String expression) throws ParserException, WrongBracketsBalanceException, ExpectedArithmeticActionException {
        int balance = 0;
    ...
    private TripleExpression<T> getExpressionMaxAndMin() throws ParserException, ExpectedArithmeticActionException {
